...
def main():
    ...
    print("2. Train MobileNet (Tuned)")
    print("3. Train DETR (Tuned)")
    ...
    if choice == "1":
        ...
        from src.models.train_mobilenet_tuned import train_mobilenet
        ...
        epochs = int(input("Enter number of epochs for MobileNet (Tuned) training: "))
        ...
        from src.models.train_detr_tuned import train_detr
        from src.cifar10_dataset import get_cifar10_dataloaders
